...
<html>
    ...
    <body>
        <h1>Hello World!</h1>
          <form name="RegisterForm" action="inserthouse.jsp" method="POST">
                <table border="1" > 
                    <tbody>
                        <tr> 
                                <td> TITLE </td>
                            ...
                            <option>KITCHEN SERVICES</option>
                            <option> PARLOUR SERVICES</option>
                            <option>COMPOUND SERVICES </option>
                            <option>ROOM SERVICES </option>
                            <option>HALF HOUSE SERVICES</option>
                            <option>FULL HOUSE SERVICES</option>
                    ...
                    <tr> 
                        <td> </td>
                        <td> <input type ='submit' value ='ORDER' name ='register' id="btn"/></td>
                    </tr>  
                    </tbody>
                </table>
          </form>
